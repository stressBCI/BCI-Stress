...
feature_matrix = [
    ...
    0.0896,	0.0175,	0.0073,	0.0083,	1.3042,	1.8802,	0; %Normal
    0.0934,	0.0180,	0.0077,	0.0087,	1.3515,	1.9132,	0; %Normal
    0.0877,	0.0171,	0.0073,	0.0082,	1.2849,	1.8630,	0; %Normal
    0.0889, 0.0173	0.0073,	0.0083,	1.2905,	1.8694,	0; %Normal

    0.0885, 0.0172, 0.0073, 0.0083, 1.2959, 1.8712, 0; %Normal
    0.0850, 0.0171, 0.0073, 0.0085, 1.3324, 1.8792, 0; %Normal
    0.0875, 0.0169, 0.0071, 0.0083, 1.3041, 1.8686, 0; %Normal
    0.0847, 0.0170, 0.0070, 0.0081, 1.2973, 1.8633, 0; %Normal
    
    0.0841, 0.0165,	0.0071,	0.0079,	1.2477,	1.8361,	1.0000;
    0.0862, 0.0169,	0.0072, 0.0081,	1.2652,	1.8498,	1.0000;
    0.0851,	0.0167,	0.0071, 0.0079,	1.2554,	1.8412,	1.0000;
    0.0815, 0.0159,	0.0069, 0.0077,	1.2540,	1.8296,	1.0000;
    
    0.0848,	0.0163,	0.0070,	0.0080,	1.2844,	1.8614, 0;
    0.0852,	0.0160,	0.0069,	0.0078,	1.2544,	1.8457, 0;
    0.0877,	0.0171,	0.0072,	0.0081,	1.2839, 1.8642, 0;
    0.0910,	0.0176,	0.0075,	0.0086,	1.3304,	1.8975, 0;
...
cv = cvpartition(size(X, 1), 'HoldOut', 0.5); % Change HoldOut to 0.8 for 80% testing
